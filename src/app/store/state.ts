import { CategorySelected, Description, FinalStepIndicator, GenreId, GenreName, Genres, NewSubgenre, StepIndicator, SubGenre, SubgenreId, SubgenresList, Submit } from "../models/genres";
